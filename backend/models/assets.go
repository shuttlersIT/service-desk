...
func NewAssetAssignmentDBModel(db *gorm.DB, assetDBModel *AssetDBModel, logger Logger) *AssetAssignmentDBModel {
...
func NewAssetDBModel(db *gorm.DB, assetAssignment *AssetAssignmentDBModel, log Logger) *AssetDBModel {
	return &AssetDBModel{
		DB:              db,
