...
// ////////////////////////////////////////////////////////////////////////////////////////
// CreateAgent creates a new agent in the database with the given details.
func (db *AgentDBModel) CreateAnAgent(agent *Agents) (*Agents, error) {
	if agent == nil {
		return nil, errors.New("provided agent is nil")
	}
