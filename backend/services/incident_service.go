...
func NewDefaultIncidentService(db *gorm.DB, incidentDBModel *models.IncidentDBModel, log models.Logger, eventPublisher models.EventPublisherImpl) *DefaultIncidentService {
